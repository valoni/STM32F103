...
//
//  Customized for FEZCerberus board
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
bool WaitForTinyBooterUpload( INT32 &timeout_ms )
{
    ...
    timeout_ms = -1;
#else // Uncomment below to allow forced entry to TinyBooter
    //if(!CPU_GPIO_GetPinState( BUTTON_PIN ))
    //{
...
void TinyBooter_OnStateChange( TinyBooterState state, void* data, void ** retData )
{
    switch(state)
    {
        ...
        case State_EnterBooterMode:
            CPU_GPIO_EnableOutputPin(LED, TRUE);
