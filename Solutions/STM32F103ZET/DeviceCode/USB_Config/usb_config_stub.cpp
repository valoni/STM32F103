...
//string descriptor
#define     MANUFACTURER_NAME_SIZE  8   /* "ALIENTEK" */
...
#define     PRODUCT_NAME_SIZE      37   /* "Micro Framework for ALIENTEK WARSHIP " */
// NOTE: If these two strings are not present, the MFUSB KERNEL driver will *CRASH*
// which, of course, causes Windows to crash
#define     DISPLAY_NAME_SIZE       5   /* "STM32" */
#define     FRIENDLY_NAME_SIZE      7   /* "WARSHIP" */
...
const struct USB_DYNAMIC_CONFIGURATION UsbDefaultConfiguration=
{
    ...
    { 'M', 'i', 'c', 'r', 'o', ' ', 'F', 'r', 'a', 'm', 'e', 'w', 'o', 'r', 'k', ' ',
      'F', 'o', 'r', ' ', 'A', 'L', 'I', 'E', 'N', 'T', 'E', 'K', ' ', 'W', 'A', 'R', 
	  'S', 'H', 'I', 'P'  },//"Micro Framework for ALIENTEK WARSHIP " 
