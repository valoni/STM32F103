...
//string descriptor
#define     MANUFACTURER_NAME_SIZE  7   /* "MZWHHWJ" */
...
#define     PRODUCT_NAME_SIZE      34   /* "Micro Framework for STM32F10E-EVAL" */
// NOTE: If these two strings are not present, the MFUSB KERNEL driver will *CRASH*
// which, of course, causes Windows to crash
#define     DISPLAY_NAME_SIZE       14   /* "STM32F10E-EVAL" */
#define     FRIENDLY_NAME_SIZE      7   /* "mzwhhwj" */
...
const struct USB_DYNAMIC_CONFIGURATION UsbDefaultConfiguration=
{
    ...
    { 'M', 'i', 'c', 'r', 'o', ' ', 'F', 'r', 'a', 'm', 'e', 'w', 'o', 'r', 'k', ' ',
      'F', 'o', 'r', ' ', 'S', 'T', 'M', '3', '2', 'F', '1', '0', 'E', '-', 'E', 'V', 
	  'A', 'L' },//"Micro Framework for STM32F10E-EVAL" 
    ...
    { 'S', 'T', 'M', '3', '2', 'F', '1', '0', 'E', '-', 'E', 'V', 'A', 'L'},/* "STM32F10E-EVAL" */
