...
INT8 Display::FillRect( UINT16 param0, UINT16 param1, UINT16 param2, UINT16 param3, UINT16 param4, HRESULT &hr )
{
    int i=0;
	int pixelCount = param2 * param3;
	int x = param0;
	int y = param1;
	int width = param2;
	int height = param3;
	...
	//HAL_Time_Sleep_MicroSeconds_InterruptEnabled(10000); // 10ms so max is 100fps that is good enough;
	color = param4;//(UINT16)((param4<<8) | (param4));
	if (screen_mode!=PORTRAIT_MODE)
	{
		x = ORG_SCREEN_WIDTH-param1-param3; 
		y = param0;
		width = param3;
		height = param2;
	}
