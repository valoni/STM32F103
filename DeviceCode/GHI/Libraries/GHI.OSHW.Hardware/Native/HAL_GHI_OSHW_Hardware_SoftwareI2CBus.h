    ...
    namespace OSHW
    {
        namespace Hardware
        {
            struct SoftwareI2CBus
            {
                ...
                static INT32& Get_clockPin( CLR_RT_HeapBlock* pMngObj )    { return Interop_Marshal_GetField_INT32( pMngObj, Library_HAL_GHI_OSHW_Hardware_SoftwareI2CBus::FIELD__clockPin ); }

                static INT32& Get_dataPin( CLR_RT_HeapBlock* pMngObj )    { return Interop_Marshal_GetField_INT32( pMngObj, Library_HAL_GHI_OSHW_Hardware_SoftwareI2CBus::FIELD__dataPin ); }
