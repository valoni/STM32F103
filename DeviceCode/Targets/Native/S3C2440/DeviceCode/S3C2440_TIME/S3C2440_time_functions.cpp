...
{
    return S3C2440_TIME_Driver::Initialize();
}


BOOL HAL_Time_Uninitialize()
{
    return S3C2440_TIME_Driver::Uninitialize();
}

UINT64 HAL_Time_CurrentTicks()
{
    return S3C2440_TIME_Driver::CounterValue();
}
...
{
    return S3C2440_TIME_Driver::CurrentTime();
}

void HAL_Time_SetCompare( UINT64 CompareValue )
{
	S3C2440_TIME_Driver::SetCompareValue(CompareValue);
}
...
{
	S3C2440_TIME_Driver::Sleep_uSec( uSec );
}
...
{
	S3C2440_TIME_Driver::Sleep_uSec_Loop( uSec );
}
