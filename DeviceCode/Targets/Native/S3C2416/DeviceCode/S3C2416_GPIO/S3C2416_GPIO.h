...
#ifndef _S3C2416_GPIO_H_1
#define _S3C2416_GPIO_H_1   1
...
typedef struct 
{
  volatile UINT32 GPIOCON ;//Configures the pins of port
  volatile UINT32 GPIODAT ;//The data register for port
  volatile UINT32 GPIOUDP ;//Pull-up/down control register for port B
  volatile UINT32 GPIOSEL ;//Selects the function of port B
...
#define GPIOA   S3C2416_GPIOA_BASE
#define GPIOB   S3C2416_GPIOB_BASE
#define GPIOC   S3C2416_GPIOC_BASE
#define GPIOD   S3C2416_GPIOD_BASE
#define GPIOE   S3C2416_GPIOE_BASE
#define GPIOF   S3C2416_GPIOF_BASE
#define GPIOG   S3C2416_GPIOG_BASE
#define GPIOH   S3C2416_GPIOH_BASE
#define GPIOJ   S3C2416_GPIOJ_BASE
#define GPIOK   S3C2416_GPIOK_BASE
#define GPIOL   S3C2416_GPIOL_BASE
#define GPIOM   S3C2416_GPIOM_BASE
