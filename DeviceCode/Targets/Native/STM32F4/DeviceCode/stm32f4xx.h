...
#define USART1_BASE           (APB2PERIPH_BASE + 0x1400) // (APB2PERIPH_BASE + 0x1000) Cerberus does not use USART1 but
#define USART6_BASE           (APB2PERIPH_BASE + 0x1400) // Cerbuino requires USART6 but it can think it is USART1
