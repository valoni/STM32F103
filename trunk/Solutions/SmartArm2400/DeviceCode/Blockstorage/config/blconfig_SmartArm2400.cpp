...
#define    FLASH_DEVICE_CODE                       	0x734B
...
const BlockRange g_SST39VF320_16_BlockRange[] =
{
    ...
    { BlockRange::BLOCKTYPE_CODE       ,  2,  159 },   // TinyCLR runtime

    { BlockRange::BLOCKTYPE_DEPLOYMENT , 160, 249 },   // TinyCLR runtime
    { BlockRange::BLOCKTYPE_DEPLOYMENT , 250, 349 },   // TinyCLR runtime
    { BlockRange::BLOCKTYPE_DEPLOYMENT , 350, 415 },   // TinyCLR runtime
    { BlockRange::BLOCKTYPE_FILESYSTEM , 416, 417 },   // TinyCLR runtime

    { BlockRange::BLOCKTYPE_CONFIG     , 418, 419 },    // g_ConfigurationSector 
    { BlockRange::BLOCKTYPE_STORAGE_A  , 420, 479 },    
    { BlockRange::BLOCKTYPE_STORAGE_B  , 480, 511 } 
